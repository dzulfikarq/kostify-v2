-- Kostify baseline schema. Runs from an empty database.
BEGIN;
...
-- ★ Race-condition guard: at most ONE pending booking per room. Two tenants
-- booking the same room at the same time → the second INSERT violates this
-- partial unique index at the database level and gets a 409.
